...
public class CAssignVariablesCollector implements
                                       CStatementVisitor<Set<String>, CPATransferException> {

  private CFANode predecessor;

  public CAssignVariablesCollector(CFANode pre) {
  ...
  public Set<String> visit(
    ...
    return pIastExpressionAssignmentStatement.getLeftHandSide().accept(
  ...
  public Set<String> visit(
      ...
      throws CPATransferException {
    return pIastFunctionCallAssignmentStatement.getLeftHandSide().accept(
        new CVariablesCollectingVisitor(this.predecessor));
  }
