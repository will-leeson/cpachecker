...
public class SlicedYDenseMatrix implements Matrix {

  private int beginSlice;
  private int endSlice;
  private Matrix matrix;

  public SlicedYDenseMatrix(
      int pBeginSlice,
      int pEndSlice,
      Matrix pMatrix) {
  ...
  public void set(int x, int y, double d) {
    if (y >= endSlice - beginSlice)
      throw new IllegalArgumentException(String
          .format("(%d, %d) is out of shape (%d, %d)", x, y, matrix.getRows(),
              endSlice - beginSlice));
  ...
  public Matrix sliceY(int begin, int end) {
    ...
    return new SlicedYDenseMatrix(begin, end, matrix);
  }
